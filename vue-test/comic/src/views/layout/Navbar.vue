<template>
  <div class="sidebar-wrap">
    <div class="left-area">
      ...
      <img class="el-header__icon" src="../../assets/images/favicon.png"/>
      <!-- <img src="../../assets/images/favicon.png" style="width: 30px; height: 30px; padding: 10px 15px"/> -->
      <span class="el-header__title">
        漫画<span class="subtitle">之家</span>
